...
NeoBundle 'git clone https://github.com/klen/python-mode'
NeoBundle 'https://github.com/vim-scripts/YankRing.vim.git'
"NeoBundle 'git clone https://github.com/Shougo/vimshell'
"NeoBundle 'git clone https://github.com/Shougo/neocomplcache'
"NeoBundle 'git clone https://github.com/Shougo/neosnippet'
"NeoBundle 'ujihisa/unite-colorscheme'
"NeoBundle 'ujihisa/unite-font'
"NeoBundle 'git clone https://github.com/vim-scripts/Align'
...
let $DOC = "C:\/local\\document"
let $DT = "C:\/Users\\kaku1864\\Desktop"
let $MRD = "C:\/SSPdev\\pleiades-e3.7\\eclipse\\workspace\\mrd\\mrd\\mrd-application\\mrd-aa"
let g:slimv_python = 'C:\/Python27\/python.exe'
let g:slimv_swank_cmd = '!start "C://lisp//sbcl.exe" --load "C:/Users/kaku1864/vimfiles/bundle/slimv/slime/start-swank.lisp"'
